...
def test_camel_case_to_snake_case():
    ...
    assert_eq(u"ñoldor", _camel_case_to_snake_case(u"Ñoldor"))
    assert_eq(u"αθήνα", _camel_case_to_snake_case(u"Αθήνα"))
    assert_eq(u"ссср_союз", _camel_case_to_snake_case(u"СССРСоюз"))
